...
def get_skills_path() -> str:
    skills_dir = files("systems_manager") / "skills"
...
def get_mcp_config_path() -> str:
    mcp_config_file = files("systems_manager") / "mcp_config.json"
                ...
                try:
                    with open(skill_file, "r") as f:
                        ...
                        if content.startswith("---"):
                            ...
                            tag_name = skill_id.replace("systems-manager-", "")
                            tags = ["systems-manager", tag_name]

...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/systems-manager"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in systems-manager
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in systems-manager but are NOT registered "
